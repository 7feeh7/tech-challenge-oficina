...
export type SupportedStatusChangedEvent = StatusChangedEventV1;
...
export function isSupportedEventVersion(
  version: unknown,
): version is typeof STATUS_CHANGED_EVENT_VERSION {
  return version === STATUS_CHANGED_EVENT_VERSION;
}
...
export function parseStatusChangedEvent(
  ...
  if (!isSupportedEventVersion(event.version)) {
