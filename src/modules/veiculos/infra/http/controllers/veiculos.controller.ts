...
import { AtualizarVeiculoUseCase } from '@/modules/veiculos/application/use-cases/atualizar-veiculo.use-case';
import { BuscarVeiculoUseCase } from '@/modules/veiculos/application/use-cases/buscar-veiculo.use-case';
import { CriarVeiculoUseCase } from '@/modules/veiculos/application/use-cases/criar-veiculo.use-case';
import { ListarVeiculosUseCase } from '@/modules/veiculos/application/use-cases/listar-veiculos.use-case';
import { RemoverVeiculoUseCase } from '@/modules/veiculos/application/use-cases/remover-veiculo.use-case';
import { CreateVeiculoDto } from '@/modules/veiculos/infra/http/dtos/create-veiculo.dto';
import { UpdateVeiculoDto } from '@/modules/veiculos/infra/http/dtos/update-veiculo.dto';
