...
import { AtualizarOrdemServicoUseCase } from '@/ordens-servico/application/use-cases/atualizar-ordem-servico.use-case';
import { BuscarOrdemServicoUseCase } from '@/ordens-servico/application/use-cases/buscar-ordem-servico.use-case';
import { CalcularTempoMedioUseCase } from '@/ordens-servico/application/use-cases/calcular-tempo-medio.use-case';
import { CriarOrdemServicoUseCase } from '@/ordens-servico/application/use-cases/criar-ordem-servico.use-case';
import { ListarOrdensServicoUseCase } from '@/ordens-servico/application/use-cases/listar-ordens-servico.use-case';
import { RemoverOrdemServicoUseCase } from '@/ordens-servico/application/use-cases/remover-ordem-servico.use-case';
import { StatusOS } from '@/ordens-servico/domain/status-os';
import { CreateOrdemServicoDto } from '@/ordens-servico/infra/http/dtos/create-ordem-servico.dto';
import { UpdateOrdemServicoDto } from '@/ordens-servico/infra/http/dtos/update-ordem-servico.dto';
