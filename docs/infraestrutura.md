...
Visão arquitetural completa: [arquitetura/visao-geral-nuvem.md](arquitetura/visao-geral-nuvem.md) e [diagramas/componentes-nuvem.md](diagramas/componentes-nuvem.md).
...
API: `http://localhost:3000`, Swagger: `http://localhost:3000/docs`. Detalhes em [configuracao.md](configuracao.md).

## Documentação relacionada

- Pipeline: [ci-cd.md](ci-cd.md)
- Rotas Gateway: [gateway-rotas.md](gateway-rotas.md)
