...
**Ordem de deploy:** infra-kubernetes → infra-database → serverless → aplicação.
...
| Coleção Postman | https://github.com/7feeh7/tech-challenge-oficina/blob/main/docs/postman/tech-challenge-fase3.postman_collection.json |
...
Texto sugerido: *"O usuário GitHub `soat-architecture` foi adicionado como colaborador com permissão de leitura/escrita nos quatro repositórios listados na seção 1, em [data]."*
